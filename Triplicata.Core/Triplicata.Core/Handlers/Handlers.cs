...
namespace Triplicata.Core.Handlers
{
    public class Handler : IHandler
    {
        ...
        private Func<TriplicataException, Task> _onCustomError;
        ...
        public IHandler OnCustomError(Func<TriplicataException, Task> onCustomError, bool rethrow = false)
        {
        ...
        public async Task ExecuteAsync()
        {
            ...
            catch (TriplicataException customException)
            {
                isFailure = true;
